...
if not on_production_server:
    # DJANGO_SIMPLE
    # Disabled model validation for speed
    pass
    #validate_models()
...
if on_production_server:
    from app.util.common.google.ereporter import ereporter
...
#template.register_temiplate_library('gae_mini_profiler.templatetags')